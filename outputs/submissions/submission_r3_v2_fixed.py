...
_HYDROGEL_PARAMS=SSTParams(take_width=8.,clear_threshold=.5,clear_width=3.,default_edge=3.,disregard_edge=1.,join_edge=3.,default_quote_size=5,max_taker_size=30,prevent_adverse=False,quote_inside_wall=True,wall_min_volume=10)
