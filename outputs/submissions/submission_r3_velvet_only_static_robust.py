...
class Trader:
    """VELVET-only robust directional probe.

    Static anchor chosen from the historical VELVET level, then tested on the
    first 100k-tick prefixes of days 0/1/2. This is a calibration upload, not
    the final combined book.
    """
