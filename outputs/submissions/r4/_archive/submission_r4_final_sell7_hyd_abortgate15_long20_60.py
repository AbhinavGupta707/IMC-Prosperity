...
# ====================================================================
# R4 FINAL HYDROGEL CANDIDATE -- sell7_hyd_abortgate15_long20_60.
#
# Mechanism:
#   - Detect early high-regime HYD path: mid >= 10020 during 20k-30k.
#   - Act immediately instead of waiting for confirmation: target 20.
#   - At 40k, require the 20k->40k mid slope to be >= 15.
