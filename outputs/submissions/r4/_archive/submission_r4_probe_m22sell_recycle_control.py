...
# ====================================================================
# R4 MARK22-SELL-GATED VEV_5000/VEV_5100 RECYCLE PROBE — CONTROL ARM.
#
# Matched-frequency control for
# submission_r4_probe_m22sell_recycle_treatment.py.
#
# Same action: a small extra recycle sell of size 5 at best_bid for
# VEV_5000 and VEV_5100, subject to position and bid thresholds.
# Same cooldown: 5,000 ticks between wrapper fires.
# DIFFERENT GATE: instead of Mark22 sell flow, fire on a fixed time
# cadence calibrated to match treatment's effective rate (~10 fires
# per 100k ticks). The first fire is delayed until 30,000 ticks to
# roughly match the typical first-Mark22-event timing in the
# observed official slice.
#
# Treatment > control by >= 150 PnL -> Mark22 identity is real alpha.
# Treatment ~ control within 100 -> alpha is the recycle action,
# not the Mark22 identity.
# ====================================================================
