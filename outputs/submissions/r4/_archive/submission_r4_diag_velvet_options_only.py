...
# ====================================================================
# R4 DIAGNOSTIC — VELVET + VOUCHERS ONLY.
# Override Trader to drop HYDROGEL orders, keep all VELVET + VEV_*
# orders. Used for official-simulator PnL attribution.
# ====================================================================
_R3_BASE_TRADER_VELVOPT = Trader

class Trader:
    def __init__(self):
        self._inner = _R3_BASE_TRADER_VELVOPT()
    def run(self, state):
