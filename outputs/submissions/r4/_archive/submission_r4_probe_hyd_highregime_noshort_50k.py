...
# ====================================================================
# R4 HYDROGEL PROBE — high-regime no-short until 50k.
#
# Medium calibration variant. If HYD is still above 10020 in the
# 20k-30k discovery window, flatten any short and suppress new shorts
# until 50k, then let the base HYD logic trade normally.
# ====================================================================
_R4_HYD_HIGHREGIME_BASE_TRADER = Trader
_HYD_HR_TRIGGER_START = 20_000
_HYD_HR_TRIGGER_END = 30_000
_HYD_HR_TRIGGER_MID = 10_020.0
_HYD_HR_CONTROL_UNTIL = 50_000
_HYD_HR_SHORT_CAP = 0
