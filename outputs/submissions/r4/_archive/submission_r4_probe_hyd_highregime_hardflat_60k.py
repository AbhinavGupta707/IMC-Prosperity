...
# ====================================================================
# R4 HYDROGEL PROBE — high-regime hard-flat until 60k.
#
# Calibration question:
#   Does a hard HYD override avoid the soft no-short leakage seen in the
#   official no-short 60k upload?
#
# Mechanism:
#   - If HYD mid >= 10020 during 20k-30k, high-regime mode activates.
#   - Before 60k, replace HYD orders with a single order toward flat, or
#     no HYD order if already flat. This suppresses the inner R3 cycle state.
#   - From 60k onward, let the base flat995 HYD sleeve trade normally.
# ====================================================================
_R4_HYD_HARD_BASE_TRADER = Trader
_HYD_HARD_TRIGGER_START = 20_000
_HYD_HARD_TRIGGER_END = 30_000
_HYD_HARD_TRIGGER_MID = 10_020.0
_HYD_HARD_CONTROL_UNTIL = 60_000
_HYD_HARD_TARGET_POS = 0
...
class Trader:
    ...
    def run(self, state):
        ...
        if self._hyd_high_regime and state.timestamp < _HYD_HARD_CONTROL_UNTIL:
