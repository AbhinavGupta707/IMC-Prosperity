...
# ====================================================================
# R4 MARK55 PASSIVE CONTROL — always-on inside VELVET bid.
#
# Diagnostic upload paired with `submission_r4_probe_mark55_m67_inside_q5.py`.
# Same quote size, price improvement, and inventory target, but without the
# Mark67 gate. This tells us whether any official gain comes from the Mark
# sequence or simply from generic VELVET short-inventory recycling.
# ====================================================================
