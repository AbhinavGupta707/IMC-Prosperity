...
# ====================================================================
# R4 SAFER VARIANT — HYDROGEL absolute-position cap of 50 from ts >= 990_000.
#
# Override the active Trader class to wrap R3 final-combined with a
# late-session HYDROGEL position cap. Velvet/voucher logic untouched.
#
# Per local-replay ablation (docs/round_4/FINAL_CANDIDATE_REVIEW.md),
# cap=50 from 990k costs $2,058 of PnL vs unguarded baseline,
# reduces +128 HYDROGEL terminal residual to +50 (-61% mark exposure),
# and emits only 6 guard orders. Useful when wanting to retain some
# late-day MM activity vs full flatten.
#
# Wrapper logic:
#   1. Calls the inner R3 trader to get its intended orders.
#   2. If state.timestamp >= _HYD_CAP_TS and |position| > _HYD_CAP_ABS,
#      OVERRIDE HYDROGEL orders with a closing order to bring position
#      back to ±_HYD_CAP_ABS. Otherwise pass through unchanged.
# ====================================================================
