...
_HYDROGEL_PARAMS=SSTParams(take_width=8.,clear_threshold=.5,clear_width=3.,default_edge=3.,disregard_edge=1.,join_edge=3.,default_quote_size=10,max_taker_size=30,prevent_adverse=False,quote_inside_wall=False,wall_min_volume=10)
...
_VEV4000_PARAMS=SSTParams(take_width=3.,clear_threshold=.5,clear_width=3.,default_edge=3.,disregard_edge=1.,join_edge=3.,default_quote_size=5,max_taker_size=10,prevent_adverse=False,quote_inside_wall=False)
...
_VOUCHER_LIQ_SPECS=VoucherSpec(strike=5400,soft_cap=50,hard_cap=100),VoucherSpec(strike=5500,soft_cap=100,hard_cap=150)
...
_VELVET_HEDGE_TIGHT_BAND=60
_VELVET_HEDGE_IDLE_DELTA=5.
_VELVET_HEDGE_IDLE_POS=5
_VELVET_HEDGE_PARAMS_PASSIVE=SSTParams(take_width=1.,clear_threshold=.5,clear_width=2.,default_edge=2.,disregard_edge=1.,join_edge=2.,default_quote_size=5,max_taker_size=10,prevent_adverse=False)
_VELVET_HEDGE_PARAMS_CROSS=SSTParams(take_width=8.,clear_threshold=.3,clear_width=2.,default_edge=1.,disregard_edge=1.,join_edge=1.,default_quote_size=5,max_taker_size=20,prevent_adverse=False)
