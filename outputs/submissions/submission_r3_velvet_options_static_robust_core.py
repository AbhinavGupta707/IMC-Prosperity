...
class Trader:
    """VELVET/options robust-core static threshold sleeve.

    HYDROGEL is intentionally disabled. This candidate was selected for
    cross-window robustness on public Round 3 full-day and 100k-window replay.
    """
